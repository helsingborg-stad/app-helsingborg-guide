...
const NotFoundScreen = (props: Props) => {
  ...
  const toSupport = () => {
    Linking.openURL(`mailto:${support}?subject=${LangService.strings.CONTACT_MAIL_SUBJECT}
        ...
        <View style={styles.notFound}>
          <View style={styles.notFoundTop}>
            <Text style={styles.notFoundTitle}>
              {LangService.strings.NOT_FOUND_TITLE}
            </Text>
            <Text style={styles.notFoundDescription}>
              {LangService.strings.NOT_FOUND_DESCRIPTION}
            </Text>
            <Text style={styles.notFoundDescription}>
              {LangService.strings.SCAN_QR_CODES_REMINDER}
            </Text>
          </View>
          <View style={styles.notFoundBottom}>
            <Text style={styles.notFoundContact}>
              {LangService.strings.NOT_FOUND_CONTACT}
            </Text>
            <TouchableOpacity onPress={toSupport}>
              <Text style={styles.notFoundMail}>
