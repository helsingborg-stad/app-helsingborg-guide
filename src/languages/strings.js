...
export default {
  ...
  sv: {
    ...
    APP_NAME: "Guide Helsingborg",
    AR_CAMERA_DISABLED: "[TRANSLATE!] Camera permission needs to be granted [TRANSLATE!]",
    AR_CHECKING: "[TRANSLATE!] Checking if this feature is supported [TRANSLATE!]",
    AR_TRANSIENT: "[TRANSLATE!] This feature is waiting to be activated [TRANSLATE!]",
    AR_SUPPORTED: "[TRANSLATE!] This feature is supported [TRANSLATE!]",
    AR_UNKNOWN: "[TRANSLATE!] This feature is unsupported [TRANSLATE!]",
    AR_UNSUPPORTED: "[TRANSLATE!] This feature is unsupported [TRANSLATE!]",
    CANCEL: "Avbryt",
    CHANGES_REQUIRES_APP_RELOAD: "Förändringar kräver app reload",
    CHECK_CAMERA_SERVICE: "[TRANSLATE!] Activate camera [TRANSLATE!]",
    ...
    MESSAGE_CAMERA_PERMISSION: "[TRANSLATE!] To continue, let the app access your camera [TRANSLATE!]",
