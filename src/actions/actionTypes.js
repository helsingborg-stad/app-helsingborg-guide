...
export const FETCH_GUIDE_TYPES_REQUEST = "FETCH_GUIDE_TYPES_REQUEST";
export const FETCH_GUIDE_TYPES_FAILURE = "FETCH_GUIDE_TYPES_FAILURE";
export const FETCH_GUIDE_TYPES_SUCCESS = "FETCH_GUIDE_TYPES_SUCCESS";
