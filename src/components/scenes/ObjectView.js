...
import { Platform, View, Text, Button, Navigator,Dimensions, TouchableOpacity, StyleSheet,ScrollView ,TouchableHighlight, TouchableWithoutFeedback } from 'react-native';
  ...
  constructor(props) {
    ...
    displayButtonsBar(){
        ...
        const audioBarItem = audioBtnVisible?null:
            (   <ButtonsBarItem disabled={this.state.audioIsLoading || this.state.audioBtnDisabled}
                    onPress={()=>{this.loadAudioFile()}}
                    name="headphones"
                    color="#7B075E"
                    size={25}
        ...
        const videoBarItem = videoBtnVisible?null:
            (
                <ButtonsBarItem disabled={this.state.videoBtnDisabled}
                                onPress={()=>{this._goToVideoView(video.url,video.title)}}
    ...
    displayImagesSlider(){
            ...
            return (
                <View style={styles.imageViewContainer} key={index} >
                    <TouchableWithoutFeedback onPress={()=>this.goToImageView(image)}>
                        <View>
                            <ImageView source={{uri:image.sizes.large}}
        ...
        return (
            <Swiper style={styles.imagesSlider}
    ...
    displayLinks(){
        if(!this.state.contentObject.links)
            return null;
            ...
            return (
                <ViewContainer >
                    ...
                    <ScrollView contentContainerStyle={styles.scrollView}>
                        <RoundedBtn style = {styles.closeBtn}
...
const styles = StyleSheet.create({
    ...
    subLocationsContainer:{flex:1,paddingVertical:20,paddingHorizontal:10},
    ...
    closeBtn:{position:'absolute', top:10,left:10,zIndex:100,width:40, height:40 , backgroundColor:'#D35098'}
