...
import {View,Text, StyleSheet,Image, Button, Dimensions, TouchableOpacity, LayoutAnimation, ScrollView, Alert, NetInfo} from 'react-native';
...
class MenuContent extends Component{
    ...
    displayLanguages(){
        ...
        return keys.map((key)=>{
            let style = {color:'#D35098'};
            let selectedStyle= (this.state.selectedLanguageCode==languages[key].code)?style:null;
            let btnDisabled =  (this.state.selectedLanguageCode==languages[key].code);
            let nativeName = languages[key].nativeName;
                     ...
                     <View style={styles.mainContentContainer}>
                         ...
                         <View style={styles.contentContainer}>
                             ...
                             <View style={styles.deleteLinkContainer}>
                                 <TouchableOpacity activeOpacity={.7} onPress={this.goToDownloadManager.bind(this)}>
                             ...
                             <View style={styles.voidView}></View>
                             <View style={styles.contactUsContainer}>
                                 <View style={styles.titleContainer}>
                                     <Text style={styles.titleText}>
                                         {LangService.strings.CONTACT_US}
                                     </Text>
                                 </View>
