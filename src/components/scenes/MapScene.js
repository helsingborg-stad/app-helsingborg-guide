...
export default class MapScene extends Component {
  ...
  _showMarkers() {
    if (this.state.markers) { return this.state.markers.map((marker, index) => <MapView.Marker key={index} coordinate={marker} image={markerImage} />); }
  }
  ...
  render() {
    ...
    return (
      <ViewContainer>
        <Navbar title={this.title} leftButton={leftBtn} rightButton={rightBtn} />
