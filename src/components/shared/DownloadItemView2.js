...
export default class DownloadItemView2 extends Component{
    ...
    render(){
        let isCompleted = (this.props.total <= this.props.currentPos) && this.props.total>0;
        let item;
        if(this.props.total == 0)
           ...
           item = Platform.OS ==='ios'?<ProgressViewIOS progressTintColor="#D35098" style={styles.progressView} progress={this.props.progress}/>:<ProgressBarAndroid color='#D35098' styleAttr="Horizontal" indeterminate={false} progress={this.props.progress} />;
