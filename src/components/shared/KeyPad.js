...
export default class Keypad extends Component{
    ...
    onDigitPressed(digit){
        ...
        let number = this.state.number+digit;
    ...
    render(){
        ...
        let noNumber = (this.state.displayedNumber=='');

        let translateY = this.state.animValue.interpolate({
            inputRange: [0, 1],
            outputRange: [FULL_HEIGHT, 0]
        });
        let animatedStyle = {transform:[{translateY:translateY}]};

        let scale = this.state.shakeValue.interpolate({
            inputRange: [0, 0.5, 1],
            outputRange: [1, 1.1, 1]
        });
        let shakeAnimatedStyle = {transform:[{scale:scale}]};
            ...
            <Animated.View style={[styles.wrapper, animatedStyle]}>
                <View style={styles.headerContainer}>
                    <View style={styles.btnContainer}>
                        <RoundedBtn style={{backgroundColor:'#7B075E'}}
                ...
                <View style={styles.padContainer}>
                    ...
                    <View style={styles.rowContainer}>
                        ...
                        <TouchableOpacity onPress={this.clearAll.bind(this)}
