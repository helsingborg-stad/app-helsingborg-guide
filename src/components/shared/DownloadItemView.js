...
export default class DownloadItemView extends Component{
    ...
    render(){
        ...
        let color = isCompleted?"green":"#D35098";

        let resumeIcon = (<Icon name="reload" color="#ED57AC" size={25} /> );
        let pauseIcon = (<Icon name="stop" color="#ED57AC" size={25} /> );
        let icon = (this.props.isCanceled)?resumeIcon:pauseIcon;
        icon= (isCompleted)?null:icon;
        let percentage =parseInt((this.props.currentPos/this.props.total)*100);
        return (
