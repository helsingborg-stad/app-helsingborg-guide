  ...
  return (
    <View style={styles.buttonTabContainer}>
      ...
      <Image
        ...
        source={currentBottomBarTab === 0 ? barTabLeft : null}
      />
      <Image
        style={styles.imageTab}
        source={currentBottomBarTab === 1 ? barTabCenter : null}
      />
      <Image
        style={styles.imageTab}
        source={currentBottomBarTab === 2 ? barTabRight : null}
      />
    </View>
  );
}
function displayIcons(currentBottomBarTab: number) {
...
const BottomBarView = (props: Props) => (
  <SafeAreaView style={styles.viewContainer}>
    {displayButtonTabs(props.currentBottomBarTab)}
    <Image
      style={styles.imageBackground}
      source={barBackground}
    />
    {displayIcons(props.currentBottomBarTab)}
