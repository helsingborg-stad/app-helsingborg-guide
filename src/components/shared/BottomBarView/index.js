...
class BottomBarView extends Component<Props> {
  displayIcons(currentBottomBarTab: number) {
    ...
    return (
      <View style={styles.iconContainer}>
        <TouchableOpacity style={styles.touchableIcon} onPress={() => this.onTouchIcon(0)}>
          <SVGImage
            source={{
        ...
        <TouchableOpacity style={styles.touchableIcon} onPress={() => this.onTouchIcon(1)}>
          <SVGImage
            source={{
              uri: `data:image/svg+xml;utf8,<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <defs></defs>
          <g id="CALENDAR" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              <rect id="Rectangle-2" stroke=${centerColor} stroke-width="2" x="3" y="6" width="18" height="15" rx="1"></rect>
              <path d="M8.03515625,7.91052246 L8.03515625,2.91052246" id="Path-5" stroke=${centerColor} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M16,7.91052246 L16,2.91052246" id="Path-5" stroke=${centerColor} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <circle id="Oval" fill=${centerColor} cx="8" cy="11" r="1"></circle>
              <circle id="Oval" fill=${centerColor} cx="12" cy="11" r="1"></circle>
              <circle id="Oval" fill=${centerColor} cx="16" cy="11" r="1"></circle>
              <circle id="Oval" fill=${centerColor} cx="8" cy="14" r="1"></circle>
              <circle id="Oval" fill=${centerColor} cx="12" cy="14" r="1"></circle>
              <circle id="Oval" fill=${centerColor} cx="16" cy="14" r="1"></circle>
              <circle id="Oval" fill=${centerColor} cx="8" cy="17" r="1"></circle>
              <circle id="Oval" fill=${centerColor} cx="12" cy="17" r="1"></circle>
              <circle id="Oval" fill=${centerColor} cx="16" cy="17" r="1"></circle>
          </g>
      </svg>`,
            }}
            style={styles.icon}
        ...
        <TouchableOpacity style={styles.touchableIcon} onPress={() => this.onTouchIcon(2)} >
          <SVGImage
            source={{
  ...
  onTouchIcon(index: number) {
    if (index !== this.props.currentBottomBarTab) {
      switch (index) {
        case 0:
          this.props.navigation.navigate("HomeScreen");
          break;
        case 1:
          this.props.navigation.navigate("WebScreen", { url: eventCalendarURL });
