...
export default class AudioPlayer extends Component{
    ...
    togglePlayView(isPlaying){
        if(!isPlaying) {
            return( <TouchableOpacity style={styles.control} onPress={()=> this.onPlayPressed()}>
                    <Icon name="play" size={20} color={FGD_COLOR} />
                </TouchableOpacity>);
        }

        return ( <TouchableOpacity style={styles.control}  onPress={()=>this.onPausePressed()}>
    ...
    render(){
        return (
            <ViewContainer style={styles.wrapper}>
                ...
                <View style={{flex:4}}>
                    <Video source={{uri: this.props.filePath}}   // Can be a URL or a local file.
                           ref={(ref) => {
                         this.player = ref
                       }}                                      // Store reference
                ...
                <View style={styles.playerContainer}>
                    <View style={styles.controlsContainer}>
                        {this.togglePlayView(this.state.isPlaying)}
                    </View>
                    ...
                    <View style={styles.sliderContainer}>
                        ...
                        <Slider
                            ...
                            onValueChange={(value)=>{this._changeCurrentTime(value)}}
