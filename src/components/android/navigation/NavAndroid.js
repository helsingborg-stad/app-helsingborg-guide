...
const routes = [
    {title: 'Splash', component:SplashView},
    //{title: 'Test', component:TestScene},
];
...
export default class Nav extends Component {
    ...
    onMainScreen(){
        let stackLength = this.refs.navigator.getCurrentRoutes().length;
    ...
    _renderScene(route, navigator){
        let scene = (<route.component navigator={navigator} {...route.passProps} />);
